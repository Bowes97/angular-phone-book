...
@Component({
  selector: 'app-angular-phone-book',
  templateUrl: './angular-phone-book.component.html',
  styleUrls: ['./angular-phone-book.component.css']
})
export class AngularPhoneBookComponent implements OnInit {
